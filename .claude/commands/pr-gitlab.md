...
5. Push the changes to a new branch named "increment-[new_number]"
6. Create a GitLab merge request with:
...
Make sure to use the glab CLI tool for creating the merge request.
